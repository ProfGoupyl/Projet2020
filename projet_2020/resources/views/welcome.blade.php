...
@section('content')
    ...
    <ul>
        ...
        <li>CHAOUNI Saïd</li>
        <li>DEMOLDER Thierry</li>
        <li>SCORNEAUX Romain</li>
        <li>REMY Clémentine</li>
        <li>CHAVALLE Céline</li>
        <li>MARCHAND François</li>
        <li>MILICAN Nicolas</li>
        <li>ROULEZ Antoine</li>
        <li>LEGRAND Florian</li>
        <li>GUERRERA Hugo</li>
        <li>SIMONET Xavier</li>
        <li>GENDARME Jo</li>
    </ul>
@endsection
