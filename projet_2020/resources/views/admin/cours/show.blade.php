    ...
    <div>
        ...
        <div class="drag-container">
            ...
            <div data-neworder="" data-element="{{$m->id}}" data-order="{{$m->ordre}}" class="draggable" draggable="true">
                ...
                <p>{{$m->titre}}</p>
                <button data-action="{{$m->id}}" data-titre="{{$m->titre}}" data-desc="{{$m->description}}" data-url="{{$m->url_video}}" class="edit-module" id="modifier" class="btn btn-primary" type="submit"><i class="fas fa-pen fa-lg"></i></button>
