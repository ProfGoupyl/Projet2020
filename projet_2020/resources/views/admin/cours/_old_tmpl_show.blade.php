...
<section>
    <div style="display:flex;justify-content:space-between;align-items:center;">
        <h1>{{$cours->titre}}</h1>
        <button class="btn btn-primary">Voir les utilisateurs isncrits pour ce cours</button>
    </div>
    <div style="display:fixed;top:50%;left:50%;transform:translate(-50%,-50%);" id="user-modal">
